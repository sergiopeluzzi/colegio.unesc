...
class block_cocoon_slider_1 extends block_base {
    ...
    function specialization() {
        if (isset($this->config->title)) {
            ...
            $this->title = get_string('newcustomsliderblock', 'block_cocoon_slider_1');
        }
    }
		...
		<div class="container-fluid p0">
            ...
            for ($i = 1; $i <= $data->slidesnumber; $i++) {
                ...
                if (!empty($data->$sliderimage)) {
                    ...
                    $text .= '
                    <div class="slide slide-one" style="background-image: url(' . moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php", "/{$this->context->id}/block_cocoon_slider_1/slides/" . $i . '/' . $mainfile) . '); height: 95vh;">
					            <div class="container">
