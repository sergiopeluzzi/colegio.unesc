...
$templatecontext = [
	...
	'MOODLE' => getConstanteMoodle(),
	'LINK_GERENCIAMENTO' => getLinkDeGerenciamento(),
	'BANNER_PRINCIPAL' => getBannerPrincipal(),
	'GET_LINKS' => getLinks(),
	'GET_INFORMATIVOS' => getInformativos(),
	'TITULO_PRINCIPAL' => getTituloPrincipal()
];
...
if (is_siteadmin()) {
    ...
    // Get the disk usage.
    $cache = cache::make('theme_unesc', 'admininfos');
...
echo $OUTPUT->render_from_template('theme_unesc/mydashboard', $templatecontext);
