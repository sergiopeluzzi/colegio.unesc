        ...
        <div class="main_blog_post_content">
          <div class="mbp_thumb_post">
						<div class="thumb">
							...
							<div class="post_date"><h2>'. $day .'</h2> <span>'. $month .'</span></div>
						</div>
						<div class="details">
              <h3>'. $entry->subject .'</h3>';
                if ($entry->renderable->usercanedit) {
                ...
                $o .= '
								<ul class="post_meta">
									<li><span class="flaticon-profile"></span></li>
          ...
          if (isset($PAGE->theme->settings->blogstyle) && ($PAGE->theme->settings->blogstyle == 1)) {
            ...
            <div class="ccn-blog-list-entry col-xs-12 main_blog_post_content mb30">
              <div class="mbp_thumb_post">
                <div class="thumb">
                 <a href="'.$entryurl.'"> <img class="img-fluid" src="'. $image .'" alt="'.$entry->subject.'"></a>
                   <div class="tag">'. $tags .'</div>
                  <a href="'.$entryurl.'"><div class="post_date"><h2>'. $day .'</h2> <span>'. $month .'</span></div></a>
                 </div>
                 <div class="details">
