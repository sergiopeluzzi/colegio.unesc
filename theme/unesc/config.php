...
$THEME->scss = function($theme) {
    ...
    return theme_unesc_get_main_scss_content($parentconfig);
};

// Process extra scss to our final stylesheet.
$THEME->extrascsscallback = 'theme_unesc_get_extra_scss';

// Process pre scss to our final stylesheet.
$THEME->prescsscallback = 'theme_unesc_get_pre_scss';

// Add a custom icon system to the theme.
$THEME->iconsystem = '\theme_unesc\util\icon_system';
