...
$string['pluginname'] = 'Unesc';
$string['configtitle'] = 'Unesc';
$string['choosereadme'] = 'Unesc é um tema moderno e altamente customizável. Este tema tem por objetivo ser usado diretamente, ou como um tema pai quando criados novos temas utilizando Bootstrap 4.';
...
$string['privacy:metadata'] = 'O tema Unesc theme não guarda qualquer informação pessoal de qualquer usuário.';
