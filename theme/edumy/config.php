...
$THEME->layouts = [
    ...
    'standard' => array(
        'file' => 'columns2.php',
        'regions' => array('user-notif', 'user-messages', 'fullwidth-top', 'fullwidth-bottom', 'above-content', 'below-content', 'left', 'side-pre',  'login', 'register', 'search', 'library-list', 'navbar'),
...
$THEME->sheets = array('bootstrap.min', 'jquery-ui.min', 'font-awesome.min', 'font-awesome-animation.min', 'menu', 'ace-responsive-menu', 'megadropdown', 'bootstrap-select.min', 'simplebar.min', 'progressbar', 'flaticon', 'animate', 'slider', 'magnific-popup', 'timecounter', 'cocoon', 'responsive', 'cocoon-mdl', 'cocoon-dashboard');
