...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_unesc/lang_menu', $context);
            }
        }
    }
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/unesc/pix";
    }
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if (!isloggedin()) {
            ...
            return $this->render_from_template('theme_unesc/frontpage_guest_loginbtn', $context);
        }
    ...
    public function render_help_icon(help_icon $helpicon) {
        ...
        // Check issue https://github.com/willianmano/moodle-theme_unesc/issues/5.
    ...
    public function search_box($identifier = false) {
        ...
        return html_writer::tag('div',
                                ...
                                array('class' => 'unesc-search-input nav-link', 'id' => $identifier));
    }
    ...
    public function breadcrumb_header() {
        ...
        if ($PAGE->pagelayout == 'mypublic') {
            $header->contextheader = "<h2>". get_string('userprofile', 'theme_unesc') ."</h2>";
        }

        return $this->render_from_template('theme_unesc/breadcrumb', $header);
    }
}
