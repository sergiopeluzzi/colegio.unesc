...
namespace theme_unesc\output\mod_forum\email;
...
class renderer_htmlemail extends \mod_forum\output\email\renderer {
    ...
    public function render_forum_post_email(\mod_forum\output\forum_post_email $post) {
        ...
        // Add our new data.
        $data['enabletemplate'] = theme_unesc_get_setting('forumcustomtemplate');
        $forumhtmlemailheader = theme_unesc_get_setting('forumhtmlemailheader', 'format_html');
        if ($forumhtmlemailheader) {
            $data['messageheader'] = $forumhtmlemailheader;
        }

        $forumhtmlemailfooter = theme_unesc_get_setting('forumhtmlemailfooter', 'format_html');
