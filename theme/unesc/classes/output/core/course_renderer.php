...
namespace theme_unesc\output\core;
...
use theme_unesc\util\extras;

/**
 * Renderers to align unesc's course elements to what is expect
 *
 * @package original   theme_moove
 * @copyright  2017 Willian Mano - http://conecti.me
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * Modificado Por Madri Produções com os devidos crédito cedidos.
 */
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $content .= html_writer::link(new moodle_url('/course/view.php', array('id' => $course->id)),
            get_string('access', 'theme_unesc'), array('class' => 'card-link btn btn-primary'));
