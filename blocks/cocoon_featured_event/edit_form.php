...
class block_cocoon_featured_event_edit_form extends block_edit_form
{
    protected function specific_definition($mform)
    {
      global $CFG;
        ...
        // Title
        $mform->addElement('text', 'config_title', get_string('config_title', 'block_cocoon_featured_event'));
        $mform->setDefault('config_title', 'Everything is Teachable');
        $mform->setType('config_title', PARAM_RAW);

        // Subtitle
        $mform->addElement('textarea', 'config_body', get_string('config_body', 'block_cocoon_featured_event'));
        ...
        // Date
        $mform->addElement('date_selector', 'config_date', get_string('config_date', 'block_cocoon_featured_event'));
        ...
        // Location
        $mform->addElement('text', 'config_location', get_string('config_location', 'block_cocoon_featured_event'));
        $mform->setDefault('config_location', 'Address: Cambridge, MA 02138, USA');
        $mform->setType('config_location', PARAM_RAW);

        // Image
        $mform->addElement('filemanager', 'config_image', get_string('config_image', 'block_cocoon_featured_event'), null,
