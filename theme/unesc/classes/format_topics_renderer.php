 ...
 * @package    theme_unesc
 */
class theme_unesc_format_topics_renderer extends format_topics_renderer {
    ...
    protected function get_nav_links($course, $sections, $sectionno) {
        ...
        while ($back > 0 and empty($links['previous'])) {
            if ($canviewhidden || $sections[$back]->uservisible) {
                ...
                $previouslink .= "<span class='text'><span class='nav_guide'>".get_string('prev_section', 'theme_unesc')."</span>";
        ...
        while ($forward <= $numsections and empty($links['next'])) {
            if ($canviewhidden || $sections[$forward]->uservisible) {
                ...
                $nextlink = "<span class='text'><span class='nav_guide'>".get_string('next_section', 'theme_unesc')."</span><br>";
    ...
    protected function section_activity_summary($section, $course, $mods) {
        ...
        if ($total > 0) {
            ...
            $output .= html_writer::tag(
                'span',
                get_string('discipline_progress', 'theme_unesc'),
