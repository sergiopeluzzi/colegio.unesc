            ...
            foreach ($entries as $entryid => $entry) {
              ...
              <a href="'.$viewblogurl.'">
								<div class="thumb">
									...
									<span class="post_date" href="'.$viewblogurl.'"><span>'. userdate($entry->created, '%d', 0) .' <br> '. userdate($entry->created, '%B', 0) .'</span></span>
								</div>
                </a>
								<div class="details">
									<div class="post_meta">
										<ul>
											<li class="ccn-white list-inline-item"><i class="flaticon-calendar"></i> '. userdate($entry->created, '%d %B %Y', 0) .'</li>
											<li class="ccn-white list-inline-item"><i class="flaticon-placeholder"></i> '. $entry->firstname .' '. $entry->lastname.'</li>
										</ul>
									</div>
            ...
            <div class="col-md-6 col-lg-3 col-xl-3">
              <div class="blog_post ccn-blog-featured-thumb">
                <a href="'.$viewblogurl.'"><div class="thumb">
                  ...
                  <span class="post_date">'. userdate($entry->created, '%d %B %Y', 0) .'</span>
                </div></a>
                <div class="details">
			...
			<div class="row mt50">
				<div class="col-lg-12">
					<div class="read_more_home text-center">
						<h4>'.format_text($this->content->footer_text, FORMAT_HTML, array('filter' => true)).' <a href="'.format_text($this->content->button_link, FORMAT_HTML, array('filter' => true)).'">'.format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)).'<span class="flaticon-right-arrow pl10"></span></a></h4>
					</div>
				</div>
			</div>
		</div>
